...
const ProductItem = ({product} : ProductGridProps) => {
  return (
    <div className=" bg-white rounded-lg overflow-hidden relative shadow-sm hover:shadow-lg transition-shadow duration-300 ease-in-out">
        ...
        <div className="p-4">
            ...
            <div className="flex flex-col">
                ...
                className="w-full text-center bg-gradient-to-r from-red-500 to-orange-500 text-white py-2 rounded-full text-sm font-bold hover:brightness-110 transition-all duration-300 active:scale-95">
                    GRAB IT NOW
                </Link>
